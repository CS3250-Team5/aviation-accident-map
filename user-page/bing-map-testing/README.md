## Requirements
To get bing maps and google maps to work, install the bing maps and google maps dependencies by running the following commands
- `npm install --save react-bingmaps` or `yarn add react-bingmaps`
- `npm install --save google-map-react` or `yarn add google-map-react`

- Bing maps will require an API key to work
